---
title: "The Impact of Winter and Summer Seasons on Mortality Rates in Toronto"
...
library(tidyverse)
library(ggplot2)
data <- read.csv("C:/Users/User/Documents/Sta304-Term-Paper-1/data/analysis_data/analysis_data.csv")
```
